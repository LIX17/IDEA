...
@section('content')
    <h1 style="float: left;">Locations list</h1>
    <form class="form-inline" style="float: right;">
        ...
        <thead>
            <tr>
            <th class="font-weight-bold">Locations</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="{{url('/type/'.$type->id)}}" type="button" class="btn btn-primary btn-lg btn-block">View Tickets</a>
                    @if(Auth::check())
